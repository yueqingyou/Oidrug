...
csv_data = open_sourcefile('csv/target_similarity.csv', header=None, low_memory=False)
...
verification(chem_dict, 'DB00006.DB00014', 0.204463113415428)

final = square_output(drug_id, chem_dict)

save_result('target_drug', matrix=final)
